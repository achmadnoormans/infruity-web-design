    ...
    <div>
        ...
        <div id="cart-items-container">
            <template x-for="(item, index) in cart" :key="item.id">
                <div class="card mb-3 p-4 cart-item position-relative"
                            ...
                            <div class="mb-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <template x-if="item.original_qty != item.qty">
                                        <span class="badge badge-light-danger ms-2 py-1 px-2" style="font-size: 0.65rem;">
                                            Dikoreksi
                                        </span>
                                    </template>
                                    @if($is_view && ($data->status ?? '') !== 'selesai' && ($type ?? '') == 'transfer-penerima')
                                ...
                                <small class="text-muted d-flex align-items-center">
                                    ...
                                    <template x-if="item.original_qty != item.qty">
                                        <div class="d-flex align-items-center">
                                            <span class="text-decoration-line-through text-gray-500 me-1" x-text="item.original_qty"></span>
