        ...
        <div class="modal-content" x-data>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-3">
                        <label class="form-label">Harga Jual Nanti</label>
                        <input type="text" class="form-control" x-model="formattedAddSell">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" inputmode="numeric"
                        x-model="addProduct.formattedAddTotalInput" @input="updateQtyFromAddTotal">
                </div>
            </div>
            ...
            <div class="modal-body">
                <div x-show="editItem">
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            <label class="form-label">Harga Beli Satuan</label>
                            <input type="text" class="form-control" x-model="formattedEditPrice" @input="updateTotalFromEditQty">
                        </div>
                        <div class="col-6">
                            <label class="form-label">Harga Jual Nanti</label>
                            <input type="text" class="form-control" step="0.01" min="0"
