                ...
                <div class="modal-body dark-modal">
                    <form action="{{ url(Request::segment(1)) }}" method="POST" id="modal_create_form">
                        ...
                        <div class="col-md-12 mb-3">
                            <label class="form-label" for="nm_layanan">Nama Form</label>
                            <input class="form-control" id="nama_form" name="nama_form" type="text" value=""
                                placeholder="Ex : Nama Pemohon">
                        </div>
                        <div class="col-md-12 mb-3">
