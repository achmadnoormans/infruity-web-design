...
@section('title-page', 'List Permohonan Pengurangan IPT')
@section('add-page')
    <a href="{{ url('ipt-pengurangan/create?tipe=8') }}" class="btn btn-md btn-primary">
        ...
        <table class="table table-hover" id="table-data">
            <thead>
                <tr>
                    ...
                    <th scope="col">Jenis Pengurangan</th>
                            ...
                            <div class="common-flex light-dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark dropdown-block">
                                    ...
                                    @if (in_array($item->id_status, [99, 100]))
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('ipt-pengurangan/' . $item->id . '/edit') }}"><i
                                    ...
                                    @if (check_access('cetak-permohonan'))
                                        <li>
                                            <a class="dropdown-item"
                                                href="{{ url('ipt-pengurangan/' . $item->id . '/cetak-permohonan') }}"><i
