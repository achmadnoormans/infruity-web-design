<tr>
    ...
    <td>bahwa tanah yang terletak di {{ $surat->alamat_persil }} merupakan tanah aset
        Pemerintah Kota
...
<tr>
    ...
    <td>bahwa Sdr. {{ $data->nama_pemohon }} adalah (suami/isteri/janda/duda veteran) dari
        {{ $surat->list_nama ?? '--' }},
        dibuktikan dengan {{ $surat->bukti }}.
    </td>
</tr>
@php
