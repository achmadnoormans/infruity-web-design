...
<body>
    ...
    <div class="container">
        <div style="line-height: 5px; margin-top : 15px">
            <p class="text-center" style="font-size:14px;"><b>KEPUTUSAN KEPALA BADAN PENGELOLAAN KEUANGAN DAN ASET
                    DAERAH</b></p>
            <p class="text-center" style="font-size:12px;"><b>KOTA SURABAYA</b></p>
            <p class="text-center" style="font-size:12px;">Nomor : </p>
            <p class="text-center" style="font-size:12px;">TENTANG : </p>
            <p class="text-center" style="font-size:12px;">PEMBERIAN PENGURANGAN RETRIBUSI IZIN PEMAKAIAN TANAH</p>
            <p class="text-center" style="font-size:12px;">DI {{ $skrd->persil }}</p>
        </div>
