...
<tr>
    ...
    <td>bahwa Sdr. {{ $data->nama_pemohon }} adalah masyarakat yang berpenghasilan di bawah atau sama dengan Upah
        Minimum Regional (UMR) Daerah, dibuktikan dengan <input type="text" class="form-control" name="bukti"
            width="50%" value="{{ $surat->bukti ?? '' }}">.
    </td>
</tr>
<tr>
    <td></td>
