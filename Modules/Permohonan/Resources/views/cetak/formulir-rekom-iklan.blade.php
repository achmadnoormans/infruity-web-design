...
<body>
    <div class="container">
                ...
                <td width="50%" style="vertical-align: top">
                    <table>
                        <tr>
                            ...
                            <td>Permohonan Penggantian Surat Izin Pemakaian Tanah (IPT)</td>
                        </tr>
                    </table>
                </td>
                <td width="50%">
        ...
        <table width="100%">
            <tr>
                <td colspan="3">Sehubungan dengan telah hilangnya surat Izin Pemakaian Tanah Nomor :
                    {{ $data->no_ipt }}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Nomor Kehilangan Dari Kepolisian</td>
                <td>:</td>
                <td><b>{{ strtoupper($data->nomor_kehilangan_dari_kepolisian) }}</b></td>
            </tr>
            <tr>
                <td>Tanggal</td>
                <td>:</td>
        ...
        <div>
            <p>
                Mohon dapat diterbitkan surat Izin Pemakaian Tanah yang baru atas persil dimaksud dan kami sanggup
                mentaati ketentuan yang berlaku.</p>
            <p>
                Demikian permohonan kami dan atas kebijaksanaannya kami ucapkan terima kasih yang sebesar-besarnya.
            </p>
        </div>
