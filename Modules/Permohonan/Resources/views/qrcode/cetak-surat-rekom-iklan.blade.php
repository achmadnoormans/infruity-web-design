...
<body>
    ...
    <div class="container">
        <div style="line-height: 5px; margin-top : 15px">
            ...
            <p class="text-center">Nomor : 500.16.7.2 /
                {{ isset($surat->nomer_surat) ? $surat->nomer_surat . '.SK' : '_____' }}/ 436.8.2 /
                {{ date('Y') }}</p>
        </div>
        <p style="text-align: justify">
            ...
            Pemakaian Tanah kepada Sdr. <b>{{ ucwords(strtolower($data->nama_pemohon ?? '')) }}</b> dengan letak persil
            tanah
            <b>{{ $surat->alamat_persil ?? '' }}</b> mendasarkan pada dokumen sebagai berikut :
        </p>
    ...
    <table width="100%">
        <tr>
            <td width="50%">
                @if ($data->jenis_iklan == 'DILOKASI')
                    <table class="table1">
                        <tr>
                            <td colspan="5" class="text-center"><b>KETERANGAN</b></td>
                        </tr>
                        <tr>
                            <td>Petugas BPKAD</td>
                            <td>Pemohon</td>
                        ...
                        <tr>
                            <td colspan="4" class="text-center"><b>TELAH DIPERIKSA</b></td>
                        </tr>
                    </table>
                @endif
            </td>
            <td>
                <table class="ttd" width="100%">
                    <tr>
                        <td><img src="{{ $qrBase64 }}" alt="" height="80px"></td>
    ...
    <div class="footer-pdf">
        <table>
            <tr>
                <td>
                    <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/cuba/images/logo/logo-bsre.png'))) }}"
                        style="height: 50px">
                </td>
                <td>
                    <div style="font-size: 10px">
                        <span>- Dokumen ini telah ditandatangani secara elektronik menggunakan sertifikat elektronik
                            yang
                            diterbitkan
                            BSrE</span><br>
                        <span>
