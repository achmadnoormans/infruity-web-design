...
<body>
    <div class="container">
                        ...
                        <tr>
                            ...
                            @php
                                switch ($data->id_layanan) {
                                    case 1:
                                        $text = 'Permohonan Fotocopy';
                                        break;
                                    case 2:
                                    case 4:
                                        $text = 'Penggantian Surat';
                                        break;
                                    case 3:
                                    case 5:
                                        $text = 'Pengalihan Surat';
                                        break;
                                    default:
                                        $text = 'Permohonan Fotocopy';
                                        break;
                            ...
                            @endphp
                            @endphp
                            <td>{{ $text }} Izin Pemakaian Tanah (IPT)</td>
                        </tr>
                    </table>
                </td>
                <td width="50%">
        ...
        <div>
            <p>Bersama ini kami mengajukan permohonan fotocopy Izin Pemakaian Tanah (IPT) sebagai berikut :</p>
        </div>
        <table width="100%">
            <tr>
            ...
            <tr>
                <td>Nama Pemegang IPT</td>
                <td>:</td>
                <td><b>{{ strtoupper($data->nama_pemegang_ipt) }}</b></td>
            </tr>
        </table>
        <div>
            <p>
                Dikarenakan IPT hilang dan guna membuat laporan kehilangan ke POLRESTABES SURABAYA. Sehubungan dengan
                hal
                tersebut, kami bersedia mentaati ketentuan yang ditetapkan sesuai peraturan perundang-undangan yang
                berlaku.</p>
            <p>
