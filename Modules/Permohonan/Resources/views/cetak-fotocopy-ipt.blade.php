...
<head>
    ...
    <title>Cetak Fotocopy IPT</title>
...
<body>
    ...
    <div class="container">
        <p class="text-right">
            Surabaya, {{ isset($surat->tgl_surat) ? dateindo($surat->tgl_surat) : '________________' }}
        </p>
        <table>
            <tr>
                <td>Nomor</td>
                <td>:</td>
                <td>500.16.7.2 / {{ isset($surat->nomer_surat) ? $surat->nomer_surat . '.SK' : '_____' }}/ 436.8.2 /
                    {{ date('Y') }}</td>
            </tr>
            <tr>
                <td>Sifat</td>
        ...
        <table>
            <tr>
                <td rowspan="4" style="vertical-align: top">Yth.</td>
        ...
        <p style="text-align: justify">
            ...
            {{ isset($data->tanggal_pengajuan) ? dateindo($data->tanggal_pengajuan) : '-' }} perihal
            permohonan
            Fotocopy Surat Izin Pemakaian Tanah yang terletak di <b>{{ $surat->alamat_persil ?? '--' }}</b> maka dengan
        ...
        <p style="text-align: justify">
            2. Surat keterangan ini dipergunakan untuk keperluan pengurusan surat kehilangan kepolisian.
        </p>
        <p>
