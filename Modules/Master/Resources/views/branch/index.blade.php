            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#kt_modal_add_customer">Add Branch</button>
                    <!--end::Add product-->
                </div>
                <!--end::Card toolbar-->
            </div>
                ...
                <form class="form" action="{{ url(Request::segment(1)) }}" id="kt_modal_add_customer_form"
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                            ...
                            <div class="fv-row mb-15">
                                <!--begin::Label-->
                                <label class="fs-6 fw-semibold mb-2">Branch Location</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control form-control-solid" placeholder=""
                                    name="address" />
    ...
    <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.fire({
                            ...
                            form.attr('action',
                                `/${segment1}`); // Misal segment1 = 'branch'
        ...
        function deleteProduct(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/branch/${id}`, // Ganti dengan URL yang sesuai
                        type: 'DELETE',
                        data: {
        ...
        function editProduct(id) {
            $.ajax({
                url: `/branch/${id}/edit`, // URL untuk mengambil data produk yang akan diedit
                type: 'GET',
                success: function(response) {
                    ...
                    form.attr('action', `/branch/${id}`); // URL untuk update produk
