            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#kt_modal_add_customer">Add Account</button>
                    <!--end::Add product-->
                </div>
                <!--end::Card toolbar-->
            </div>
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                            ...
                            <div class="fv-row mb-15">
                                <!--begin::Label-->
                                <label class="fs-6 fw-semibold mb-2">Account Name</label>
                                <!--end::Label-->
                                <!--begin::Input-->
    ...
    <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.fire({
                            ...
                            form.attr('action',
                                `/${segment1}`); // Misal segment1 = 'account'
        ...
        function deleteProduct(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/account/${id}`, // Ganti dengan URL yang sesuai
                        type: 'DELETE',
                        data: {
        ...
        function editProduct(id) {
            $.ajax({
                url: `/account/${id}/edit`, // URL untuk mengambil data produk yang akan diedit
                type: 'GET',
                success: function(response) {
                    ...
                    form.attr('action', `/account/${id}`); // URL untuk update produk
