    ...
    <div>
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-ecommerce-product-filter="search" id="search"
                            class="form-control form-control-solid w-250px ps-12" placeholder="Search Handling" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--end::Card title-->
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                        data-bs-target="#kt_modal_add_customer">Add Handling</button>
                    <!--end::Add product-->
                </div>
                <!--end::Card toolbar-->
            </div>
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="handling-table">
                    <thead>
            ...
            <div class="modal-content">
                ...
                <form class="form" action="{{ url(Request::segment(1)) }}" id="kt_modal_add_customer_form"
                    ...
                    <div class="modal-header" id="kt_modal_add_customer_header">
                        <!--begin::Modal title-->
                        <h2 class="fw-bold">Add a Handling</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            dataTable = $('#handling-table').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ajax: {
                    url: "{{ route('handling-data') }}",
                    data: function(d) {
        ...
        function deleteProduct(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/handling/${id}`, // Ganti dengan URL yang sesuai
                        type: 'DELETE',
                        data: {
        ...
        function editProduct(id) {
            $.ajax({
                url: `/handling/${id}/edit`, // URL untuk mengambil data produk yang akan diedit
                type: 'GET',
                success: function(response) {
                    ...
                    form.attr('action', `/handling/${id}`); // URL untuk update produk
