    ...
    <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.fire({
                            ...
                            form.attr('action',
                                `/${segment1}`); // Misal segment1 = 'payment-method'
        ...
        function deleteProduct(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/payment-method/${id}`, // Ganti dengan URL yang sesuai
                        type: 'DELETE',
                        data: {
        ...
        function editProduct(id) {
            $.ajax({
                url: `/payment-method/${id}/edit`, // URL untuk mengambil data produk yang akan diedit
                type: 'GET',
                success: function(response) {
                    ...
                    form.attr('action', `/payment-method/${id}`); // URL untuk update produk
