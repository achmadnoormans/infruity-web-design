<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
    data-kt-menu-offset="-50,0" class="menu-item menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
    <!--begin:Menu link-->
                ...
                <div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                    ...
                    <div class="row">
                            ...
                            <div class="menu-item p-0 m-0">
                                ...
                                <a href="{{ url('products') }}" class="menu-link">
                                    ...
                                    <span class="d-flex flex-column">
                                        ...
                                        <span class="fs-7 fw-semibold text-muted">Management Product</span>
                                    </span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="menu-item p-0 m-0">
                                ...
                                <a href="{{ url('category') }}" class="menu-link">
                                    ...
                                    <span class="d-flex flex-column">
                                        <span class="fs-6 fw-bold text-gray-800">Categories</span>
                                        <span class="fs-7 fw-semibold text-muted">Manajemen Category</span>
                                    </span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="menu-item p-0 m-0">
                                ...
                                <a href="{{ url('unit') }}" class="menu-link">
                                    ...
                                    <span class="d-flex flex-column">
                                        <span class="fs-6 fw-bold text-gray-800">Product
                                            Unit</span>
                                        <span class="fs-7 fw-semibold text-muted">Manajemen Unit</span>
                                    </span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="menu-item p-0 m-0">
                                ...
                                <a href="{{ url('location') }}" class="menu-link">
                                    ...
                                    <span class="d-flex flex-column">
                                        <span class="fs-6 fw-bold text-gray-800">Location</span>
                                        <span class="fs-7 fw-semibold text-muted">Manajemen location</span>
                                    </span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a href="{{ url('handling') }}" class="menu-link">
                                    <span
                                        class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                        <i class="ki-outline ki-switch text-warning fs-1"></i>
                                    </span>
                                    <span class="d-flex flex-column">
                                        <span class="fs-6 fw-bold text-gray-800">Handling</span>
                                        <span class="fs-7 fw-semibold text-muted">Handling</span>
                                    </span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="menu-item p-0 m-0">
                                ...
                                <a href="{{ url('departmen') }}" class="menu-link">
                                    ...
                                    <span class="d-flex flex-column">
                                        <span class="fs-6 fw-bold text-gray-800">Department</span>
                                        <span class="fs-7 fw-semibold text-muted">Manajemen Department</span>
                                    </span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <div class="menu-item p-0 m-0">
                                ...
                                <a href="{{ url('position') }}" class="menu-link">
                                    ...
                                    <span class="d-flex flex-column">
                                        <span class="fs-6 fw-bold text-gray-800">Position</span>
                                        <span class="fs-7 fw-semibold text-muted">Position</span>
                                    </span>
                                </a>
                                <!--end:Menu link-->
                            </div>
